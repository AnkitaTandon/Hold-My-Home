...
<html>
    ...
    <div class="row">
        ...
        <?php foreach($home as $i): ?> 
                    <div class="card" style="width:400px; font-family: cursive; height:590px;margin-bottom:10px;margin:15px 15px;  margin-bottom:30px; background-color:rgb(190,190,190,0.6);border-radius:25px;border:0px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
