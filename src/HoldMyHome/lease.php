<?php
    ...
    $sql= "SELECT sid, name, phone, email, SRL, loc, owned_since, price, descp, image FROM sell where SRL='Lease';";
...
<html>
    ...
    <body>
        ...
        <li ><a href="home.html">Home</a></li>
            ...
            <li ><a class="active" href="lease.php">Lease</a></li>
    ...
    <div class="row">
        ...
        <?php foreach($home as $i): ?> 
                    <div class="card" style=" width:400px; font-family: cursive; height:650px; margin:15px 15px; margin-bottom:30px; 
                        background-color:rgb(190,190,190,0.6); border-radius:25px; border:0px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        ...
                        <br><hr>
                        <form action="https://formspree.io/f/mbjqkajw" method="POST" enctype="multipart/form-data">
                        <label> Your email ID to get in touch: <input type="email" name="_replyto"></label><br><br>
                        <label>Leave a message:&emsp;<input type="text" id="message" name="message"></label>
                        <br><br>
